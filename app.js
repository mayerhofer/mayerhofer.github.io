...
window.appTemplates.components = {
  LogInForm: `
...
class RComponent {
  ...
  fill(itemTemplate, data) {
    let temp = window.appTemplates.components[itemTemplate] ?? itemTemplate;
...
class GenericTable extends RComponent {
  ...
  rowToHtml(row) {
    ...
    let buttons = '';
    if (typeof this.props.handleEdit === 'function') {
      const editImg = this.fill('image', {img: window.appTemplates.images64['edit']});
      const editBtn = this.fill('button', {id: this.id + 'EditBtn' + row.elementId, className: 'act-btn', content: editImg});
      const delBtn = this.fill('button', {id: this.id + 'DelBtn' + row.elementId, className: 'act-btn', content: this.fill('image', {img: window.appTemplates.images64['delete']})});
...
const labelImages = [
  {
    label: 'Work',
    alias: 'work',
    img: window.appTemplates.images64['work'],
  },
  {
    label: 'Health',
    alias: 'health',
    img: window.appTemplates.images64['health'],
  },
  {
    label: 'Investments',
    alias: 'investment',
    img: window.appTemplates.images64['investment'],
  },
  {
    label: 'Dinner',
    alias: 'dinner',
    img: window.appTemplates.images64['dinner'],
  },
  {
    label: 'Grosseries',
    alias: 'market',
    img: window.appTemplates.images64['market'],
  },
  {
    label: 'Transport',
    alias: 'transport',
    img: window.appTemplates.images64['transport'],
  },
  {
    label: 'Leisure',
    alias: 'leisure',
    img: window.appTemplates.images64['leisure'],
  },
  {
    label: 'Service',
    alias: 'service',
    img: window.appTemplates.images64['service'],
  },
  {
    label: 'House',
    alias: 'house',
    img: window.appTemplates.images64['house'],
  },
  {
    label: 'Tourism',
    alias: 'tourism',
    img: window.appTemplates.images64['tourism'],
  },
  {
    label: 'Sweets',
    alias: 'sweet',
    img: window.appTemplates.images64['sweet'],
  },
  {
    label: 'Gift',
    alias: 'gift',
    img: window.appTemplates.images64['gift'],
  },
  {
    label: 'Education',
    alias: 'study',
    img: window.appTemplates.images64['study'],
  },
  {
    label: 'Tax',
    alias: 'tax',
    img: window.appTemplates.images64['tax'],
  },
];
/////////////////////////////////////////////
