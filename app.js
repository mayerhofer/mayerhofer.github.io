...
class GenericTable extends (0, _rcomponent.RComponent) {
    ...
    rowToHtml(row) {
        ...
        if (typeof this.props.buildEditComponent === "function") {
            ...
            const editBtn = this.fill("button", {
                id: this.id + "EditBtn" + row.elementId,
                className: "act-btn",
                content: editImg
            });
            const delBtn = this.fill("button", {
                id: this.id + "DelBtn" + row.elementId,
                className: "act-btn",
                content: this.fill("image", {
                    img: (0, _templates.images64)["delete"]
                })
            });
            const selBtn = this.fill("button", {
                id: this.id + "SelBtn" + row.elementId,
                className: "act-btn",
                content: this.fill("image", {
                    img: (0, _templates.images64)["select"]
                })
            });
    ...
    render() {
        if (this.state.showEdit) {
            ...
            const label = this.fill("simplediv", {
                className: "table__header-label",
                content: new Date().toISOString().substring(0, 10)
            });
            const count = this.fill("simplediv", {
                className: "table__header-label",
                content: this.state.data.length + ": " + (this.state.start + 1) + "-" + (this.state.end > this.state.data.length ? this.state.data.length : this.state.end)
            });
            const backwards = this.fill("button", {
                id: this.id + "Backwards",
                className: "table__header-add" + (this.state.start === 0 ? " disabled" : ""),
                content: "<span>&lt;</span>"
            });
            const forwards = this.fill("button", {
                id: this.id + "Forwards",
            ...
            if (typeof this.props.buildEditComponent === "function") {
                ...
                button = this.fill("button", {
                    id: buttonId,
                    className: "table__header-add",
                    content: "<span>+</span>"
                });
                this.registerHandler(buttonId, ()=>this.handleEdit.bind(this)());
            }
            const header = this.fill("simplediv", {
                className: "table__header",
                content: label + count + backwards + forwards + button
            });
...
class WishListForm extends (0, _rcomponent.RComponent) {
    ...
    handleSave() {
        ...
        if (this.isEditMode) api.update(saveObj);
        else api.insert(saveObj);
    }
    render() {
        // Util Functions
        ...
        const date = this.fill("dateTextField", {
            id: this.id + "Date",
            label: "Date",
        ...
        const save = this.fill("imgButton", {
            id: this.id + "Save",
            disabled: "",
...
const commonFormatters = {
    ...
    amount: (row)=>{
        ...
        return {
            tagName: "simplediv",
            className: "cashflowAmount" + (isIncome ? " income" : " expense"),
            content
        };
    }
};
    ...
    const props = {
        ...
        formatter: {
            ...
            provider: (row)=>{
                ...
                return {
                    tagName: "simplediv",
                    className: "cashflowProvider",
                    content
                };
            }
        }
    };
    (0, _rcomponent.RComponent).buildRoot(props, (p)=>new GenericTable(p));
};
...
},{"./framework/RComponent":"iu3rT","./templates":"18mfC","./servers/entity":"kW8fe","./busCompts/financeForm":"390bl","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./busCompts/liabilityForm":"aAgzo","./components/toast.js":"clg1H","./busCompts/liabilityReport":"bi7Wn"}],"iu3rT":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
const labelImages = [
    {
        label: "Work",
        alias: "work",
        img: (0, _templates.images64)["work"]
    },
    {
        label: "Health",
        alias: "health",
        img: (0, _templates.images64)["health"]
    },
    {
        label: "Investments",
        alias: "investment",
        img: (0, _templates.images64)["investment"]
    },
    {
        label: "Dinner",
        alias: "dinner",
    ...
    },
    {
        label: "Transport",
        alias: "transport",
        img: (0, _templates.images64)["transport"]
    },
    {
        label: "Leisure",
        alias: "leisure",
        img: (0, _templates.images64)["leisure"]
    },
    {
        label: "Service",
        alias: "service",
        img: (0, _templates.images64)["service"]
    },
    {
        label: "House",
        alias: "house",
        img: (0, _templates.images64)["house"]
    },
    {
        label: "Tourism",
        alias: "tourism",
        img: (0, _templates.images64)["tourism"]
    },
    {
        label: "Sweets",
        alias: "sweet",
        img: (0, _templates.images64)["sweet"]
    },
    {
        label: "Gift",
        alias: "gift",
        img: (0, _templates.images64)["gift"]
    },
    {
        label: "Education",
        alias: "study",
        img: (0, _templates.images64)["study"]
    },
    {
        label: "Tax",
        alias: "tax",
        img: (0, _templates.images64)["tax"]
    }
];
const buildNewState = (isEdit, props)=>{
    ...
    return {
        ...
        nextElementId: isEdit ? cf.elementId : props.data.map((d)=>d.elementId).filter((id)=>id > 0).sort((a, b)=>a - b).pop() + 1,
...
class FinanceForm extends (0, _rcomponent.RComponent) {
    constructor(props){
        ...
        this.state = {
            ...
            ...buildNewState(this.isEditMode, props)
        };
    }
    componentDidMount() {
        const self = this;
    ...
    cleanState() {
        const base = buildNewState(this.isEditMode, this.props);
        this.setState(base);
    }
    isValidToSave() {
    ...
    render() {
        ...
        let date = this.fill("dateTextField", {
            id: this.id + "Date",
            label: "Date",
            value: this.state.date.toISOString().slice(0, 11) + this.state.date.toString().slice(16, 21)
        });
        ...
        }, (p)=>new (0, _backButtonDefault.default)(p));
...
},{"../framework/RComponent":"iu3rT","../templates":"18mfC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./flagCombo":"8O4nh","../components/textField":"hj91c","./liabilityModal":"grrMq","./saveButton":"8tKCQ","../components/toast":"clg1H","../servers/entity":"kW8fe","./backButton":"6uiKD"}],"8O4nh":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _rcomponent = require("../framework/RComponent");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hj91c":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _rcomponent = require("../framework/RComponent");
...
},{"../framework/RComponent":"iu3rT","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"grrMq":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _rcomponent = require("../framework/RComponent");
var _templates = require("../templates");
...
},{"../framework/RComponent":"iu3rT","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../templates":"18mfC","../components/textField":"hj91c"}],"8tKCQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _rcomponent = require("../framework/RComponent");
class SaveButton extends (0, _rcomponent.RComponent) {
    render() {
...
},{"../framework/RComponent":"iu3rT","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6uiKD":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _rcomponent = require("../framework/RComponent");
class BackButton extends (0, _rcomponent.RComponent) {
    render() {
        this.registerHandler(this.id, this.props.handler);
        return this.fill("imgButton", {
            id: this.id,
...
},{"../framework/RComponent":"iu3rT","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aAgzo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _rcomponent = require("../framework/RComponent");
var _textField = require("../components/textField");
...
},{"../framework/RComponent":"iu3rT","../components/textField":"hj91c","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../servers/entity":"kW8fe","./saveButton":"8tKCQ","../components/toast":"clg1H"}],"bi7Wn":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _rcomponent = require("../framework/RComponent");
var _entity = require("../servers/entity");
...
},{"../framework/RComponent":"iu3rT","../servers/entity":"kW8fe","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["gEwwu","1SICI"], "1SICI", "parcelRequirece5e")
