...
class GenericTable extends (0, _rcomponent.RComponent) {
    ...
    handleEdit(element) {
        if (typeof this.props.handleEdit === "function") this.props.handleEdit(this.state.data, element);
    }
    ...
    const handleEdit = (data, element)=>{
        ...
        optionApi.get().then((options)=>{
            ...
            (0, _rcomponent.RComponent).buildRoot({
                ...
                data,
                element
            }, (p)=>new (0, _financeFormDefault.default)(p));
        });
    };
    const props = {
        id: "cfMainTable",
...
window.app.loadLiability = function() {
    const handleEdit = (data, element)=>{
        (0, _rcomponent.RComponent).buildRoot({
            ...
            data,
            element
        }, (p)=>new (0, _liabilityFormDefault.default)(p));
    };
...
},{"./framework/RComponent":"iu3rT","./templates":"18mfC","./servers/entity":"kW8fe","./busCompts/financeForm":"390bl","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./busCompts/liabilityForm":"aAgzo","./components/toast.js":"clg1H"}],"iu3rT":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class FinanceForm extends (0, _rcomponent.RComponent) {
    constructor(props){
        ...
        this.state = {
            ...
            nextElementId: this.isEditMode ? this.props.element.elementId : this.props.data.map((d)=>d.elementId).filter((id)=>id > 0).sort((a, b)=>a - b).pop() + 1,
    ...
    handleSave() {
        ...
        else cfApi.insert(saveObj).then(()=>{
...
},{"../framework/RComponent":"iu3rT","../templates":"18mfC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./flagCombo":"8O4nh","../components/textField":"hj91c","./liabilityModal":"grrMq","./saveButton":"8tKCQ","../components/toast":"clg1H","../servers/entity":"kW8fe"}],"8O4nh":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _rcomponent = require("../framework/RComponent");
...
},{"../framework/RComponent":"iu3rT","../components/textField":"hj91c","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../servers/entity":"kW8fe","./saveButton":"8tKCQ","../components/toast":"clg1H"}]},["gEwwu","1SICI"], "1SICI", "parcelRequirece5e")
